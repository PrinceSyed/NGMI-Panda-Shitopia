...
pc.script.createLoadingScreen(function (app) {
    var showSplash = function () {
        ...
        logo.src = 'https://cdn.discordapp.com/attachments/995566406282264608/1000236281592287342/ngmipanda-logo.png';
...
// tp.js
var Tp = pc.createScript('tp');

Tp.prototype.initialize = function() {
    this.entity.collision.on('triggerenter', this.onCollision, this);
};

// update code called every frame
Tp.prototype.update = function(dt) {
    this.entity.rotate(new pc.Vec3(15,30,45).scale(dt));
};

Tp.prototype.onCollision = function(event) {
    this.app.fire('CountShit');
    this.entity.destroy();
};
...
Overlay.prototype.initialize = function() {
    ...
    this.app.on('CountShit', this.setCoinCount, this);
};
